      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in with your GitHub account to create and manage issues
          </p>
        </div>
        <div className="mt-8 space-y-6">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              By signing in, you authorize this app to access your GitHub repositories and create issues on your behalf.
            </p>
          </div>
        </div>
      </div>
